import type { Event, GameState, Item, ItemTag, SettlementService, SettlementType } from './types'
import { handlers } from './utils/event-utils'
...
export const eventData: Event[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        handler: handlers.triggerCombat(),
      },
      {
        label: 'Ignore',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        handler: 'You ignore the trees and decide to go somewhere else.',
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        handler: {
          ...
          callback: <T extends GameState>(gs: T) => gs,
        },
      },
      {
        ...
        handler: {
          ...
          callback: <T extends GameState>(gs: T, event: Event) => gs,
        },
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        handler: {
          message: '70%: Successfully sneak past the wolves, 30%: Get detected and attacked.',
          callback: <T extends GameState>(gs: T, event: Event) => gs,
        },
      },
      {
