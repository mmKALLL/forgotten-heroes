...
export const settlementServicesBySize = [
  ...
  { id: 7, name: 'Tinkerer / Finesmith', ratios: [18, 17, 15, 13, 11, 9] },
  ...
  { id: 20, name: 'Necromancy / Resurrection', ratios: [20, 19, 18, 17, 16, 16] },
  ...
  { id: 26, name: 'Healer / Physician', ratios: [18, 15, 12, 10, 7, 4] },
  { id: 27, name: 'Shipping Contracts / Port (if coastal)', ratios: [19, 18, 16, 14, 12, 10] },
...
export const settlementServiceActions: Pick<SettlementService, 'id' | 'name' | 'actions'>[] = [
  ...
  { id: 7, name: 'Tinkerer / Finesmith', actions: [] },
  ...
  { id: 20, name: 'Necromancy / Resurrection', actions: [] },
  ...
  { id: 26, name: 'Healer / Physician', actions: [] },
  { id: 27, name: 'Shipping Contracts / Port (if coastal)', actions: [] },
